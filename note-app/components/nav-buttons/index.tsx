...
export default function Nav_Buttons() {
    ...
    return (
        <div className="w-full flex flex-col">
            ...
            <button onClick={()=>change_pane("Archived")} className={`flex px-3 w-full ${current_pane === "Archived"? "bg-auth_page text-text9 rounded-lg":"bg-none text-text7"} justify-between items-center`}>
                <span className="flex items-center gap-2">
                    {archived_svg}
                    <span>All Notes</span>
                </span>
