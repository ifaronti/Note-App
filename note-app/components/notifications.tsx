...
export default function Notification() {
    ...
    return (
        <div
            className={`${toast? 'left-[40%] bg-auth_page notification bottom-10 w-[250px] flex h-8 items-center fixed text-text9 px-2 gap-2 rounded-lg border border-[#E0E4EA]': 'hidden left-0'}`}
        >
        <div>
            {
