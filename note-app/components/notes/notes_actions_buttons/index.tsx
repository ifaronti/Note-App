            ...
            <div className={`flex gap-2 text-sm`}>
                ...
                <div className="flex xl:flex-row gap-2 flex-row-reverse">
                    <button
                        ...
                        type="button"
                        className="xl:bg-[#335CFF] focus:animate-bounce xl:focus:animate-pulse xl:h-[41px] xl:w-[99px] text-[#355CFF] rounded-lg xl:text-white bg-none hover:text-[#2547D0] xl:hover:text-[white] border-none xl:hover:bg-[#2547D0]"
                    >
